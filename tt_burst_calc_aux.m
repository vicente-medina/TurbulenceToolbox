...
function [quadrant,pulse,velocities_pulse]=tt_burst_calc_aux(VEL_OUT)
   %% QUADRANTS
   ...
   [quad,per]=tt_burst_quadrants(VEL_OUT);
   ...
   [pul,ind_pul,quad_pul]=tt_burst_pulse(quad);
   ...
   [v_avg_pul]=tt_burst_vel_avg_pul(VEL_OUT,ind_pul); 
   ...
   [v_max_pul]=tt_burst_vel_max_pul(VEL_OUT,ind_pul);
   ...
   [v_avg_pul_dur,v_avg_mean_pul_dur,v_max_pul_dur,v_max_mean_pul_dur,percent_pul_dur,v_quad_pul_dur]=tt_burst_pulse_sep(pul,v_avg_pul,v_max_pul,quad_pul);
